...
`define INST_REG_ADDR     4:0     // 通用寄存器地�?位宽
`define INST_REG_DATA     31:0    // 通用寄存器数据位�?
`define INST_DB_REG_DATA  63:0    // 双�?�寄存器数据位宽

// 常数定义
`define CLK_FREQ            'd50_000_000  // 系统时钟频率(Hz)
`define UART_BPS            'd19200       // 串口波特�?(Bps)
`define REG_NUM             32
`define ROM_NUM             32768
`define RAM_NUM             32768
`define SMALL_ROM_NUM       256
`define SMALL_RAM_NUM       256
...
// MUL运算类型
`define MUL          3'b001   // 有符号乘�?
`define MULSU        3'b010   // 有符号乘以无符号
`define MULU         3'b011   // 无符号乘�?

// DIV运算类型
`define DIV          3'b001   // 有符号除�?
`define DIVU         3'b010   // 无符号除�?
`define REM          3'b011   // 有符号取�?
`define REMU         3'b100   // 无符号取�?
...
`define INS_SLT     10'b00_0000_0010  // 小于�?1
`define INS_SLTU    10'b00_0000_0011  // 无符号数比较小于�?1
...
// 无条件跳转指�?
`define INS_JAL         7'b110_1111  // 立即�?+pc
`define INS_JALR        7'b110_0111  // 立即�?+寄存�?+pc
...
// funct3
`define INS_SB          3'b000  // �?8�?
`define INS_SH          3'b001  // �?16�?
`define INS_SW          3'b010  // �?32�?

// 访存指令LOAD  
`define INS_TYPE_LOAD        7'b000_0011 
// funct3
`define INS_LB          3'b000  // �?8�?
`define INS_LH          3'b001  // �?16�?
`define INS_LW          3'b010  // �?32�?
`define INS_LBU         3'b100  // �?8位，无符号拓�?
`define INS_LHU         3'b101  // �?16位，无符号拓�?
